package com.cobona.vici.core.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "vici.muti-datasource")
public class MutiDataSourceProperties {

    //默认的数据源名称
    private String defaultDataSourceName = "dataSourceVici";

package com.cobona.vici.core.exception;
...
public class ViciException extends RuntimeException {
	...
	protected ViciException(int friendlyCode, String friendlyMsg, String urlPath) {
		this.setValues(friendlyCode, friendlyMsg, urlPath);
	}

	public ViciException(ViciExceptionEnum bizExceptionEnum) {

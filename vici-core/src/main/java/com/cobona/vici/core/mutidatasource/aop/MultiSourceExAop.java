package com.cobona.vici.core.mutidatasource.aop;
...
import com.cobona.vici.core.mutidatasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.cobona.vici.core.mutidatasource.annotion.DataSource)&& !execution(public * com.cobona.vici.jicheng.controller.WebSocketController.*(..))")
    private void cut() {

...
(function () {
    var BSTable = function (bstableId, url, columns) {
        ...
        this.defultNumber = "14";
        this.defaultList = [10,20];				//默认分页列表
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    pageSize: this.defultNumber,      			//每页的记录行数（*）
                    pageList: this.defaultList,  	//可供选择的每页的行数（*）
                    ...
                    fixedColumns: this.fixedColumns,         //是否冻结列
                    fixedNumber: this.fixedNumber,             //是否行数
                    height: this.height,
                    icons: {
         ...
         * 设置页面行数
         */
        setDefultNumber: function (num) {
        	this.defultNumber = num;
        },
        setDefaultList: function () {
        	this.defaultList="[";
        	for (var i=0;i<arguments.length;i++){
        		this.defaultList+=arguments[i]+",";
        	}
        	this.defaultList = this.defaultList.substring(0, this.defaultList.length - 1);
        	this.defaultList+="]";
        },
        /**
         * 设置是否冻结窗格
         */
        setFixedColumns: function (type,num) {
        	this.fixedColumns = type;

...
function getbase64(id){      
    ...
    var ajax = new $ax(Feng.ctxPath + "/sun_product/detail/"+id, function(data){
    	debugger;
    	editor.txt.html(htmlspecialchars_decode(data.remark));
      $("#servicecategory").val( data.servicecategory);
       if( data.servicecategory!=""){
       Sun_productInfoDlg.loadSelectBypids("productcategory",data.servicecategory);
       }
       $("#productcategory").val(data.productcategory);
       if(data.productcategory!=""){
           Sun_productInfoDlg.loadSelectBypids("producttype",data.productcategory);
           }
...
function collectdate(data) {
	...
	data.field['remark'] =htmlspecialchars_decode(Sun_productInfoDlg.editor.txt.html());
}
$(function() {

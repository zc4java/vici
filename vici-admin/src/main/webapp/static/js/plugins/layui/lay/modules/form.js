      ...
      layui.each(vers, function(_, thisVer){
        ...
        if(verify[thisVer]){
          if(thisVer!=="required"&&value===""){
        	...
        	var strs=thisVer.split("_");
        	if(strs[0]==="minmax"){
        		var min= Number(strs[1]);
        		var max= Number(strs[2]);
        		if(value<min){
        			errorText="不得小于"+min;
					isTrue=true;
				}else if(value>max){
        		...
        		var max= Number(strs[1]);
        		if(value>max){
        			errorText="不得大于"+max;
					isTrue=true;
				}
        	}else if(strs[0]==="lengthminmax"){
        		var min= Number(strs[1]);
        		var max= Number(strs[2]);
        		var length=value.length;
        		if(length<min){
        			errorText="长度不得小于"+min;
					isTrue=true;
				}else if(length>max){
					errorText="长度不得大于"+max;
					isTrue=true;
				}
        	}else if(strs[0]==="lengthmin"){
        		var min= Number(strs[1]);
        		var length=value.length;
        		if(length<min){
        			errorText="长度不得小于"+min;

...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: 'Vue组件名', field: 'componentname', align: 'center', valign: 'middle', sortable: true},
        {title: '绑定对象名', field: 'objectname', align: 'center', valign: 'middle', sortable: true},
...
Menu.openAddAllMenu = function () {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/menu/menu_addall'
    });
    debugger;
    this.layerIndex = index;
};

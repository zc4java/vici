...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '权限配置', field: 'accreditName', align: 'center', valign: 'middle', sortable: true},
...
MgrUser.setAuthority = function () {
	if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/mgr/setAuthority/' + this.seItem.id
        });
        this.layerIndex = index;
    }
}
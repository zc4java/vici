...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('password').set('avatar')
        .set('email').set('name').set('birthday').set('rePassword').set('deptid').set('phone').set('accredit');
};
...
UserInfoDlg.chePwd = function () {
	var ajax = new $ax(Feng.ctxPath + "/mgr/checkPwd", function (data) {
...
$(function () {
    ...
    $("#accredit").val($("#accreditValue").val());

package com.cobona.vici.core.shiro.factory;
...
public class ShiroFactroy implements IShiro {
	...
	@Override
	public List<String> findPermissionsByDeptId(Integer deptId) {
		List<String> resUrls = menuDao.getResUrlsByDeptId(deptId);
        return resUrls;
	}

	@Override
	public List<String> findPermissionsByUserId(Integer userId) {
		List<String> resUrls = menuDao.getResUrlsByUserId(userId);
        return resUrls;
	}

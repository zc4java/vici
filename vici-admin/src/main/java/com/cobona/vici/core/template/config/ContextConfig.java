...
public class ContextConfig {
    ...
    private String projectPath = "F:\\workspace-sts-3.9.2.RELEASE\\vici-parent";//模板输出的项目目录
    ...
    private String modelPackageName = "com.cobona.vici.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.cobona.vici.common.persistence.dao";  //model的dao

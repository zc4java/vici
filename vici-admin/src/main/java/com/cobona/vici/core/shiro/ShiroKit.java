...
public class ShiroKit {
    ...
    public  static boolean useSalt;
    
    @Value("${vici.hashIterations:1024}")
    public   int hashIterationsTmp ;
    @Value("${vici.useSalt:true}")
    public   boolean useSaltTmp;
    @PostConstruct
    public void setHashIterations() {  
    	this.hashIterations = hashIterationsTmp;  
    } 
    @PostConstruct
    public void setUseSalt() {  
    	this.useSalt = useSaltTmp;  
    } 

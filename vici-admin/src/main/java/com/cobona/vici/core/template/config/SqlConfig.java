...
import com.cobona.vici.common.constant.state.IsMenu;
import com.cobona.vici.common.constant.state.MenuOpenStatus;
...
public class SqlConfig {
    ...
    public void init() {
    	...
    	//this.setConnection(dataSourceConfig.getConn());
